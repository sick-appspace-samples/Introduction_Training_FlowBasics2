## Introduction_Training_FlowBasics2
How to utilize a control flow
...
The purpose of this one is to basically describe how to use a control flow.

### Topics
training, introduction, flow, control, sampleapp, sick-appspace
