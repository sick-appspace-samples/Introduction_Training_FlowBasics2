...
---@param inString string total number of data codes found
local function printValue( inString )
  Log.warning( "Called from Data Flow with value: '" .. inString .. "';" )
end
Script.serveFunction( "Training.printValue", printValue )
